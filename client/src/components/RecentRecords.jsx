...
//     <h1 className="text-2xl font-bold text-purple-700 mb-4">Recent Records</h1>
...
//             <th className="sticky-col py-3 bg-purple-100 px-4 text-left">Date</th>
//             <th className="py-3 px-4 text-left">Fasting (mg/dL)</th>
//             <th className="py-3 px-4 text-left">Fasting Time</th>
//             <th className="py-3 px-4 text-left">Fasting Status</th>
//             <th className="py-3 px-4 text-left">After Lunch (mg/dL)</th>
//             <th className="py-3 px-4 text-left">After Lunch Time</th>
//             <th className="py-3 px-4 text-left">After Lunch Status</th>
//           </tr>
//         </thead>
//         <tbody>
//           {recentData.map((record, idx) => (
//             <tr key={idx} className="border-b last:border-none">
//               <td className="sticky-col py-3 px-4 font-semibold bg-purple-100">{record.date}</td>
//               <td className="py-3 px-4">{record.fasting}</td>
//               <td className="py-3 px-4">{record.fastingTime}</td>
//               <td className={`py-3 px-4 font-semibold ${getStatusColor(record.fasting)}`}>
//                 {getStatus(record.fasting)}
//               </td>
//               <td className="py-3 px-4">{record.afterLunch}</td>
//               <td className="py-3 px-4">{record.afterLunchTime}</td>
